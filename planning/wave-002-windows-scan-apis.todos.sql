...
INSERT INTO todos (ref, title, status, track, step, letter, adr, notes) VALUES
  ...
  ('wave002-B', 'Wave 002 B — Build: windows-scan-apis', 'pending', 'wave-002-windows-scan-apis', 2, 'B', '0001', 'Build/install saned configured for 127.0.0.1 only; implement the x64 WIA 2.0 minidriver and separately enumerated WIA device without changing the HR7 USB WinUSB binding; configure SANEWinDS for TWAIN x86/x64. Expose the HR7 flatbed only.'),
